package id.ac.politeknikharber.praktikum10
...
import id.ac.politeknikharber.praktikum10.catatan.Note
import kotlinx.android.synthetic.main.note_item.view.*


class NoteAdapter  : androidx.recyclerview.widget.ListAdapter<Note, NoteAdapter.NoteHolder>(
    DIFF_CALLBACK
) {
    companion object {
